...
m.geometry('220x300')
t=tk.StringVar()
e=tk.Entry(master=m,textvariable=t,border=10)
...
b=tk.Button(master=f,text='+',command=lambda:button('+',t),border=0).pack(expand=True,side=LEFT,fill='both')
...
b=tk.Button(master=f1,text='-',command=lambda:button('-',t),border=0).pack(expand=True,side=LEFT,fill='both')
...
b=tk.Button(master=f2,text='*',command=lambda:button('*',t),border=0).pack(expand=True,side=LEFT,fill='both')
...
b=tk.Button(master=f3,text='.',border=5,command=lambda:button('.',t)).pack(expand=True,side=LEFT,fill='both')
b=tk.Button(master=f3,text='clear',command=clear,border=0).pack(expand=True,side=LEFT,fill='both')
b=tk.Button(master=f3,text='=',command=result,border=0).pack(expand=True,side=LEFT,fill='both')
b=tk.Button(master=f3,text='/',command=lambda:button('/',t),border=0).pack(expand=True,side=LEFT,fill='both')
